...
const ekstrakurikuler = [
  { nama: "Pramuka", deskripsi: "Melatih kemandirian, kepemimpinan dan kedisiplinan siswa." },
  { nama: "Paskibra", deskripsi: "Membentuk karakter dan kekompakan dalam baris-berbaris." },
  { nama: "PMR", deskripsi: "Pelatihan dasar pertolongan pertama dan kegiatan sosial." },
  { nama: "Tari", deskripsi: "Menyalurkan bakat seni tari tradisional dan modern." },
  { nama: "Rebana", deskripsi: "Mengenal musik Islami dan seni budaya daerah." },
  { nama: "Dance", deskripsi: "Ekspresi diri melalui gerakan tari modern." },
  { nama: "BTQ", deskripsi: "Baca Tulis Al-Quran untuk membentuk karakter religius." },
  { nama: "Sepak Bola", deskripsi: "Melatih fisik, strategi dan kerjasama tim." },
  { nama: "Bola Volly", deskripsi: "Olahraga populer yang meningkatkan kebugaran dan kekompakan." },
  { nama: "Bola Basket", deskripsi: "Mengembangkan kecepatan, kelincahan, dan kekompakan tim." },
  { nama: "Pemrograman Web", deskripsi: "Mengenal dunia coding dan pengembangan website." },
  { nama: "Futsal", deskripsi: "Olahraga dalam ruangan yang seru dan menantang." },
  { nama: "NJK (Bahasa Jepang)", deskripsi: "Belajar budaya dan bahasa Jepang dengan menyenangkan." },
  { nama: "ECC (Bahasa Inggris)", deskripsi: "Meningkatkan kemampuan bahasa Inggris siswa." },
  { nama: "Ekstra Band", deskripsi: "Wadah bagi siswa yang memiliki minat bermusik." },
  { nama: "Cheerleader", deskripsi: "Kombinasi tari dan olahraga yang penuh semangat." },
  { nama: "KIR", deskripsi: "Karya Ilmiah Remaja untuk mengembangkan daya pikir." },
  { nama: "Paduan Suara", deskripsi: "Mengasah kemampuan vokal dan musikalitas." },
  { nama: "CSF", deskripsi: "Komunitas Siswa Katolik yang aktif dan inklusif." },
  { nama: "Chinematografi", deskripsi: "Belajar produksi video dan storytelling visual." },
  { nama: "Taekwondo", deskripsi: "Beladiri yang menekankan disiplin dan kekuatan fisik." },
  { nama: "Seni Rupa", deskripsi: "Mengembangkan kreativitas dalam seni visual." },
  { nama: "FCC", deskripsi: "French Culture Club – belajar budaya dan bahasa Prancis." },
